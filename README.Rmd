...
`tinyvalid` is a lightweight R package for **validating tabular data**.  
...
It returns a tidy tibble of issues, making it easy to catch problems early in your pipeline.
